...
\hspace{42mm} \parbox{5.15in}{\textit{Awarded RIT's 2026 Distinguished Alumni Award}} \\
...
% \hspace{2.5mm} \parbox{1.5in}{\textit{Techniques \\\\}} \parbox{5.15in}{Highly multiwavelength analysis including X-ray, ultraviolet, optical, and infrared imaging and spectroscopy (\textit{Chandra}, \textit{HST}, \textit{JWST}, \textit{Spitzer}, \textit{Herschel}, VLT, Keck, Gemini etc.), as well as submillimeter and radio interferometry (ALMA, JVLA) } \\

\vspace*{-2mm}

\begin{center}
\textit{Portfolio consists of more than 100 refereed publications (20+ as first author, including in Nature), \\ three books for the general public, and over \$6M USD in funding (over \$1M as P.I.) }  \\
\end{center}
...
\parbox{5.15in}{Gordon \& Betty Moore Foundation Grant for Next-Gen X-ray Optics $|$ \textbf{\$3.2M} \\
Smithsonian Innovation Concepts Award (2026) $|$ \textbf{\$150K} as P.I. \\
Smithsonian Institution Scholarly Studies Grant (2021) $|$ \textbf{\$60K} \\
Smithsonian Astrophysical Observatory B\&P Award (2020) $|$ \textbf{\$100K} as co-P.I.\\
Smithsonian Astrophysical Observatory IR\&D for the \textit{Lynx} Study $|$ \textbf{\$750K} as co-P.I.

NRAO ALMA Ambassadors Program (2017) $|$ \textbf{\$10K} as P.I.

New York Space Grant Consortium $|$ \textbf{\$10K} as P.I.
}
...
% \hspace{2.5mm} \parbox{1.5in}{\textit{Selected Programs \\ as Co-Investigator \\(continued) \\\\\\\\\\\\\\\\\\\\\\}} \parbox{5.15in}{
% \textbullet~~ALMA Cycle 1 Project 2012.1.00837.S, P.I.: B.~McNamara\\
% \textbullet~~ALMA Cycle 0 Project 2011.0.00374.S, P.I.: B.~McNamara\\
% \textbullet~~\textit{HST}  Cycle 24 DDT Program 14486, P.I.: B.~Husemann\\
% \textbullet~~\textit{HST}  Cycle 22 GO Program 13638, P.I.: M.~Bayliss\\
...
\textbf{Distinguished Alumni Award, RIT College of Science} (2025)\\
\textit{``Presented to alumni who have brought distinction at the highest levels to their college or RIT through professional, community, or philanthropic achievements. It is the highest honor that an RIT College can bestow upon its graduates.''}\\
\textbf{NASA Silver Group Achievement Award} (2024)\\
...
\textbf{Osase Omoruyi}, Harvard University $|$ Ph.D. Astrophysics (completed May 2025)\\
 \textit{Awarded NSF GRFP and ALMA SOS Fellowships (2023) \\
\textit{Now a Carnegie-Princeton and CCA Postdoctoral Fellow at Princeton (2025)}}
\\
...
% \hspace{2.5mm} \parbox{1.5in}{\textit{Professional Telescope \\ Experience \\ (continued)\\}} \parbox{5.15in}{
% \textbf{Support Astronomer $|$ Very Large Telescope} (Unit Telescope 2 / Kueyen)\\
% Official ESO duties, 40 nights per year. In charge of the science operation of the telescope including the XSHOOTER, UVES, and FLAMES spectrographs, quality assessment of the data, and the support of visiting astronomers.
% }\\
...
% 2012-2014: Formally represented the European Southern Observatory (ESO) across various meetings with and visits by the President of the European Commission (J. Barroso, 2014), the President of Chile (S. Piñera, 2014), the European Union's High Representative Foreign Affairs (C. Ashton, 2014), the Prime Minister of Sweden (C. Bildt, 2014), the German Science Minister, and the Brazilian Ambassador to Germany. I was appointed to these positions by the ESO Director General, citing my ability to engage with stakeholders in an engaging, enthusiastic way while being able to safeguard the organization's interests, stay on message, and strengthen ESO's status as an engine of scientific leadership in Europe and Chile.

% 2019: Spent a long weekend with the NASA Administrator (J. Bridenstine) and NASA Associate Administrator for Science (T. Zurbuchen), representing the CfA and our interests in Lynx and Chandra. I have maintained a personal relationship with these two leaders to this day.

% 2020: Alongside Smithsonian Office of Government Relations, I presented Chandra and Lynx Science to the U.S. House of Representatives including several members and dozens of staffers

% 2022: Represented the American Astronomical Society (AAS) and our membership at the U.S.-Africa Leaders summit (Washington, DC, December 2022), sponsored by the White House and the U.S. Department of State. Led negotiations in what resulted in a formal set of Resolutions between the African Astronomical Society (AfAS), the International Astronomical Union (IAU), and the AAS in the lead up to the 2024 IAU General Assembly in Cape Town.

% 2024: Selected by the Smithsonian Office of Government Relations to conduct an on-camera interview with Rep. Joe Morelle (D-NY), a powerful Appropriator and Chair of the Smithsonian's Oversight Committee. That interview can be viewed here: https://www.youtube.com/watch?v=ODV4zwPwuAU
...
\item \uline{Omoruyi, O.}, \textbf{Tremblay, G.~R.}, Baum, S.~A, Clarke, T.~E., Dabhade, P., Fabian, A., Gaspari, M., Gulati, S., Kharb, P., Markevitch, M., Nulsen, P., O'Dea, C.~P., Randall, S., Rayachaudhury, S., Vaddi, S., Vikhlinin, A., \& ZuHone, J., \textit{``A Deep Chandra view of Abell 2597: Bubbles, Shocks, Cold Fueling, and a Plasma Depletion Layer''}, \textbf{ApJ in press} (2025)

\item \uline{Duggal, C.}, O'Dea, C.~P., Baum, S.~A., Jiwa, J., \textbf{Tremblay, G.~R.}, Chiaberge, M., Miley, G., Stanghellini, C., Sparks, W.~B., \textit{``Mapping Feedback Signatures in 3C 297: a Quasar-host merger at Cosmic Noon''}, \textbf{ApJ in press} (2025)
...
\item Dunn, T., McElroy, R., Krumpe, M., Croom, S.~M., Gaspari, M., P\'{e}rez Torres, M., Cowley, M., Omoruyi, O., \textbf{Tremblay, G.~R.}, \& Singha, M., \textit{``A century of change: new changing look event in Mrk 1018's past'}, \textbf{PASA} in press (2025)
...
\item \textbf{Tremblay, G.~R.}, \ul{\textit{The Sky \& Other Ghosts: Our Fading Age of Discovery}} (working title), a forthcoming 350 page book on the history of NASA's Great Observatories, coming 2026 from Princeton Press
...
\textbf{PASA} $|$ \textit{Publications of the Astronomical Society of Australia}
