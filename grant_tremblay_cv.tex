...
\begin{center}
\textit{Portfolio consists of sixty-four publications (fourteen as first author, including in Nature), \\ two books for the general public, and over \$1.4M USD in funding (\$436,475 as P.I.)}  \\
\end{center}
...
\textit{Sixty-four publications, fourteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
...
Busch, G., Gaspari, M., Croom, S.~M., at the CARS team, \textit{``The Close AGN Reference Survey (CARS): Jet-driven outflow and stellar feedback in the edge-on galaxy HE 1353-1917''}, \textbf{A\&A} in press (2019)
...
\item Gaspari, M., Eckert, D., Ettori, S., Tozzi, P., Bassini, L., Rasia, E., Brighenti, F., Sun, M., Borgani, S., Johnson, S. D., Tremblay, G., Stone, J., Temi, P., Yang, H. -Y. K., Tombesi, F., Cappi, M., \textit{``The X-ray Halo Scaling Relations of Supermassive Black Holes''}, submitted to \textbf{ApJ} (2019)
