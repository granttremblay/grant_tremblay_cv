...
Space mission development (\textit{Lynx X-ray Observatory}; Europa Lander)  } \\
...
\begin{center}
\textit{Portfolio consists of fifty-five publications and over \$1.4M USD in funding (\$436,475 as P.I.)}  \\
\end{center}
...
\textit{Fifty-five publications, thirteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
...
\item Ricci, F., Lovisari, L., Kraft, R.~P., Massaro, F., Paggi, A.,
Liuzzo, E., \textbf{Tremblay, G.~R.}, Forman, W.~R., Baum, S.~A., O'Dea, C.~P.,
\& Wilkes, B.~J., \textit{``Stormy weather in 3C 196.1: nuclear outbursts
and merger events shape the environment of the hybrid radio galaxy 3C 196.1''}, \textbf{ApJ} in press (2018)

\item Busch, G., Husemann, B., Smirnova-Pinchukova, I., Eckart, A., Baum, S.~A.,
Combes, F., Croom, S.~M., Davis, T.~A., Fazeli, N., Fischer, C., Gaspari, M.,
Klein, R., Krumpe, M., McElroy, R.~E., O'Dea, C.~P., P\'{e}rez-Torres, M.~A.,
\uline{Powell, M.~C.}, S\'{a}nchez-Monge, \'{A}., Scharw\"{a}chter, J., \textbf{Tremblay, G.~R.}, \& Urrutia, T., \textit{``The Close AGN Reference Survey (CARS): SOFIA detects spatially-resolved [C~\textsc{ii}] emission in the luminous AGN HE0433-1028''}, \textbf{ApJL} in press (2018)

\item Balmaverde, B., Capetti, A., Marconi, A., Venturi, G.,
Chiaberge, M., Baldi, R.~D., Baum, S.~A., Gilli, R., Grandi, E.,
Meyer, E., Miley, G., O'Dea, C.~P., Sparks, W.~B., Torresi, E.,
\& \textbf{Tremblay, G.~R.}, \textit{``The MURALES Survey. I. A Dual AGN in the Radio Galaxy 3C 459?''}, \textbf{A\&A} in press (2018)
...
\item \textbf{Tremblay, G.~R.}~and the Smithsonian Astrophysical Observatory. \uline{\textit{Light from the Void}}, a forthcoming publication from Smithsonian Books celebrating \textit{Chandra}'s two decades of discovery. (2019)

\item \textbf{Tremblay, G.~R.} \& Coppens, K., \uline{\textit{Space Made Simple}}, a forthcoming Children's Book from Tilbury House Publishers. (2020)
