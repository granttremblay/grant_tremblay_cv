...
\begin{center}
\textit{Portfolio consists of seventy publications (fifteen as first author, including in Nature), \\ two books for the general public, and over \$1.9M USD in funding (over \$500,000 as P.I.) }  \\
\end{center}
...
\parbox{5.15in}{
CfA IR\&D funding for the \textit{Lynx X-ray Observatory} Concept Study $|$ \textbf{\$400K}
...
\hspace{2.5mm} \parbox{1.5in}{\textit{Formal Postdoc \\Supervision \\\\}} \parbox{5.15in}{\textbf{Dr.~Rebecca Nevin} \& \textbf{Dr. Bryan Terrazas} \\ Current Postdoctoral Research Fellows in the Tremblay Group \\
...
\hspace{2.5mm} \parbox{1.5in}{\textit{NASA Advisory Roles}\\\\} \parbox{5.15in}{\textbf{Executive Committee Member} \& XRSIG Co-chair\\ NASA Physics of the Cosmos Program Analysis Group (2019 \textit{to present})\\
}
...
% Kevin Ortiz Ceballos, Banneker Institute Student \\
...
\textit{Seventy publications, fifteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
...
in the Centers of Galaxy Clusters''}, submitted to \textbf{Science} (2019)
...
Available at \texttt{www.lynxobservatory.org/report}\\
...
\item \textbf{Great Observatories: The Past and Future of Panchromatic Astrophysics} \\ Consensus report of the NASA Great Observatories Science Analysis Group (SAG-10), \textit{available Fall 2019}\\
...
\item \textbf{Tremblay, G.~R.} \& Coppens, K., \uline{\textit{What do Black Holes Eat for Dinner?}}, a forthcoming children's book from Tumblehome Learning (\textit{available June 2020})
