...
\begin{center}
\textit{Portfolio consists of sixty-five publications (fourteen as first author, including in Nature), \\ two books for the general public, and over \$1.4M USD in funding (\$436,475 as P.I.)}  \\
\end{center}
...
% \textbf{\textit{Lynx X-ray Observatory}} \\ Head of the \textit{Lynx} Science Support Office $|$ Branding \& Graphic Design Lead $|$
}
...
\textit{Sixty-five publications, fourteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
