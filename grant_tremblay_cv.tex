...
\begin{center}
\textit{Portfolio consists of more than 120 refereed publications (seventeen as first author, including in Nature), \\ three books for the general public, and over \$2.2M USD in funding (over \$750,000 as P.I.) }  \\
\end{center}
...
\textit{Over 120 publications, sixteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
...
\item Bogdan, A., Goulding, A. D., Natarajan, P., Kov\'{a}cs, O.~E., \textbf{Tremblay, G.~R.}, Chadayammuri, U., Volonteri, M., Kraft, R.~P., Forman, W. R., Jones, C., Churazov, E., \& Zhuravleva, I., \textit{Evidence for a heavy-seed origin of early supermassive black holes from a z$\approx$10 X-ray Quasar}, \textbf{Nature Astronomy}, 8, 126 (2024)
