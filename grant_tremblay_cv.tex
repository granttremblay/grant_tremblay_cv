...
\begin{center}
\textit{Portfolio consists of sixty-eight publications (fifteen as first author, including in Nature), \\ two books for the general public, and over \$1.9M USD in funding (over \$500,000 as P.I.) }  \\
\end{center}
...
\textit{Sixty-eight publications, fifteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
...
\item \textbf{Tremblay, G.~R.} \& Coppens, K., \uline{\textit{Space Made Simple}}, a forthcoming children's book from Tumblehome Learning (\textit{available Fall 2019})
