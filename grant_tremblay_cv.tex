...
\hspace{42mm} \parbox{5.15in}{Deputy Lead for SAO, \textit{Lynx X-ray Observatory} NASA Strategic Mission Study}
...
\begin{center}
\textit{Portfolio consists of sixty publications (fourteen as first author, including in Nature), \\ two books for the general public, and over \$1.4M USD in funding (\$436,475 as P.I.)}  \\
\end{center}
...
Head of the \textit{Lynx} Science Office at SAO $|$ www.lynxobservatory.com \\
...
\textit{Sixty publications, fourteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
...
\item Husemann, B., Scharwaechter, J., Davis, T.~A., \textbf{Tremblay, G.~R.},
Smirnova-Pinchukova, I., Krumpe, M., P\'{e}rez-Torres, M., Urrutia, T., \uline{Powell, M.},
Busch, G., Gaspari, M., Croom, S.~M., at the CARS team, \textit{``The Close AGN Reference Survey (CARS): Jet-driven outflow and stellar feedback in the edge-on galaxy HE 1353-1917''}, submitted to \textbf{A\&A} (2019)
...
\& Voit, G.~M., \textit{``Deep and narrow CO absorption revealing molecular clouds in the Hydra-A Brightest Cluster Galaxy''}, \textbf{MNRAS} in press (2019)
...
\item \textbf{Tremblay, G.~R.} et al., \uline{\textit{Light from the Void: Chandra's Two Decades of Discovery}}, a forthcoming coffee table book celebrating \textit{Chandra}'s
twentieth launch anniversary from Smithsonian Books (Fall 2019)
