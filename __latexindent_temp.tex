...
% \hspace{42mm} \parbox{5.15in}{Lecturer $|$ Harvard University Department of Astronomy}
...
\begin{center}
\textit{Portfolio consists of seventy-three publications (fifteen as first author, including in Nature), \\ two books for the general public, and over \$2.1M USD in funding (over \$630,000 as P.I.) }  \\
\end{center}
...
\textit{Seventy-three publications, fifteen as first author, including in} Nature. \textit{Papers in preparation are not listed.}
